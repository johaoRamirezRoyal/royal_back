...
class AdmissionsController extends Controller
{
    ...
    protected UsuariosServices $usuarios_services;

    public function __construct(AdmisionesServices $admisionesServices, CloudinaryService $cloudinaryService, AuthServices $service_auth, UsuariosServices $usuarios_services, private JwtService $jwt)
    {
        $this->admisiones_services = $admisionesServices;
        $this->cloudinary_service = $cloudinaryService;
        $this->service_auth = $service_auth;
        $this->usuarios_services = $usuarios_services;
    }
