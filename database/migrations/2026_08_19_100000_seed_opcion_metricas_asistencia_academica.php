...
{
    private const NOMBRE_OPCION = 'Métricas de Asistencia Académica';
    private const ID_MODULO_ACADEMICO = 14;
    // Vicerrector y Directivo Docente: solo el dashboard de métricas de asistencia por
    // curso, de solo lectura (no la toma de asistencia ni la configuración académica,
    // que siguen detrás de la opción 99). Ver GestionAcademicaController::__construct
    // para cómo se combina (OR) esta opción con la 99, restringida al único endpoint
    // de métricas.
    private const PERFILES_CON_ACCESO = [12, 20];
