...
{
    private const NOMBRE_OPCION = 'Noticias';
    private const ID_MODULO_GESTION_HUMANA = 3;
    // Super Admin, Administrador, Recursos humanos — mismo set que Configuración de
    // asistencia (ver 2026_08_06_010002_seed_opcion_configuracion_asistencia.php).
